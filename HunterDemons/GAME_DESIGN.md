...
- **Правая верхняя зона** — свайп для поворота камеры в стиле third-person shooter;
  движение всегда идёт относительно направления камеры, а атаки — по прицелу.
- **ПРЫЖОК** — вертикальный прыжок; нажать **УДАР** в воздухе, чтобы выполнить
  удар с приземлением по площади.
...
- На десктопе для отладки: WASD, Space/J — удар, Q/E — скиллы, R — ульта;
  C — прыжок; обзор — удерживать правую кнопку мыши и вести мышь.
